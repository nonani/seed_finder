...
//지원분야 business_classfication_id
//대상연령 target_age_id
//기관명 company_name
//연락처 contact_number
//지역 support_region_id
//접수기간 start_date~ end_date
//기관구분 supervising_organization
//창업연력 business_duration
...
class EventDetail with _$EventDetail {
  factory EventDetail({
    ...
    // 지원분야
    @JsonKey(name: "business_classification_name")
    required String businessClassificationName,
    // 대상
    @JsonKey(name: "application_target_names") required String target,
    // 기관명
    @JsonKey(name: "company_name") required String companyName,
    // 연락처
    @JsonKey(name: "contact_number") required String contactNumber,
    // 지역
    @JsonKey(name: "support_region_name") required String supportRegion,
    @JsonKey(name: "start_date") required DateTime startDate,
    @JsonKey(name: "end_date") required DateTime endDate,
    @JsonKey(name: "detailed_page_url") required String detailPageUrl,
    //연령
    @JsonKey(name: "total_age") required String targetAge,
    // 기관구분
    @JsonKey(name: "supervising_organization")
    required String supervisingOrganization,
    // 창업연력
    @JsonKey(name: "total_business_duration") required String businessDuration,
    // 담당부서
    @JsonKey(name: "department_in_charge") required String departmentInCharge,
  }) = _EventDetail;
